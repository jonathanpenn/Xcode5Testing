...
- (void)testClickingButtonChangesLabel {
    XCTAssertEqualObjects(self.controller.countLabel.text, @"clicked: 0");
    [self.controller buttonTapped:nil];
    XCTAssertEqualObjects(self.controller.countLabel.text, @"clicked: 1");
    [self.controller buttonTapped:nil];
    XCTAssertEqualObjects(self.controller.countLabel.text, @"clicked: 2");
}
